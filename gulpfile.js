...
gulp.task('watch', function() {
	gulp.watch('app/sass/**/*.sass', gulp.parallel('sass')).on('change', browserSync.reload); // Наблюдение за sass файлами
	gulp.watch('app/**/*.php').on('change', browserSync.reload);
	gulp.watch('app/js/*.js').on('change', browserSync.reload);
	gulp.watch(['app/js/common.js', 'app/libs/**/*.js'], gulp.parallel('scripts')).on('change', browserSync.reload); // Наблюдение за главным JS файлом и за библиотеками
});
